  ...
  <div className="col-span-1 bg-white shadow-lg p-6 rounded">
    <div className="mb-8">
      <div className="flex items-center space-x-4">
        <div className="text-red-500"><i className="fas fa-phone-alt text-3xl"></i> </div>
        <h3 className="text-xl font-medium">Call To Us</h3>
      </div><p className="mt-4 text-gray-500">
        We are available 24/7, 7 days a week.
      </p>
      <p className="mt-2 font-medium text-gray-700">Phone: +880161112222</p>
    </div><hr/>
    <div className="mt-8">
      <div className="flex items-center space-x-4">
  ...
  <div className="col-span-2 bg-white shadow-lg p-6 rounded">
    ...
    <form className="space-y-4">
      ...
      <textarea
        ...
        className="w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-red-500"></textarea>
      <button 
        type="submit"
        className="bg-red-500 text-white px-6 py-2 rounded hover:bg-red-600 focus:ring-2"
      >
        Send Message</button>
    </form>
  </div>
